...
* Ask for help on [BitcoinTalk](https://bitcointalk.org/index.php?topic=1262920.0) or on the [Securypto Forum](http://forum.pivx.org/).
* Join our Discord server [Discord Server](https://discord.pivx.org)
* Join one of our Slack groups [Securypto Slack Groups](https://pivx.org/slack-logins/) (Main community is replaced by Discord).
...
Development
---------------------
The Pivx repo's [root README](https://github.com/Securypto-Project/Securypto/blob/master/README.md) contains relevant information on the development process and automated testing.
...
* Discuss on the [BitcoinTalk](https://bitcointalk.org/index.php?topic=1262920.0) or the [Securypto](http://forum.pivx.org/) forum.
* Join the [Securypto-Dev](https://pivx-dev.slack.com/) Slack group ([Sign-Up](https://pivx-dev.herokuapp.com/)).
