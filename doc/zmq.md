...
The Securypto Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Securypto Core requires ZeroMQ API version 4.x or
...
using. Securyptod appends an up-counting sequence number to each
