...
*Setup instructions for a gitian build of Securypto using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Securypto
...
- [Building Securypto](#building-pivx)
...
To build Securypto (for Linux, OSX and Windows) just follow the steps under 'perform
