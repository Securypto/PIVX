Contributing to Securypto Core
============================

The Securypto Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Securypto Core project, and is not to be
confused with overall Securypto Network Protocol consensus changes.

Whether a pull request is merged into Securypto Core rests with the project merge
...
Patches that change Securypto consensus rules are considerably more involved than
...
Where a patch set proposes to change the Securypto consensus, it must have been
...
The project leader is the release manager for each Securypto Core release.
