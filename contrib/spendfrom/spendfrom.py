#!/usr/bin/env python
#
# Use the raw transactions API to spend SCUs received on particular addresses,
...
def determine_db_dir():
    ...
    if platform.system() == "Darwin":
        return os.path.expanduser("~/Library/Application Support/Securypto/")
    elif platform.system() == "Windows":
        return os.path.join(os.environ['APPDATA'], "Securypto")
...
def main():
    ...
    parser.add_option("--from", dest="fromaddresses", default=None,
                      help="addresses to get SCUs from")
    parser.add_option("--to", dest="to", default=None,
                      help="address to get send SCUs to")
