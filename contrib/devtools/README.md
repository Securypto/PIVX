...
Securypto-Project/Securypto repository.
...
Setup
---------
Configuring the github-merge tool for the Securypto repository is done in the following way:

    git config githubmerge.repository Securypto-Project/Securypto
...
A script to optimize png files in the Securypto
